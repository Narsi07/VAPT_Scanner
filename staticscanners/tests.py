...
class StaticScanTest(TestCase):
    ...
    def test_static_scan_list(self):
        ...
        response = client.get("/staticscanners/list_scans/")
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "staticscanners/scans/list_scans.html")
    ...
    def test_static_scan_vuln_info(self):
        client = Client()
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "staticscanners/scans/list_vuln.html")
    ...
    def test_static_scan_vuln_mark(self):
        client = Client()
        ...
        response = client.post("/staticscanners/vuln_mark/", data=data)
        self.assertEqual(response.status_code, 302)

        vuln_info = StaticScanResultsDb.objects.filter(vuln_id=vuln_id)
        for vuln in vuln_info:
    ...
    def test_static_scan_details(self):
        client = Client()
        ...
        response = client.get("/staticscanners/scan_details/?vuln_id=%s" % vuln_id)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "staticscanners/scans/vuln_details.html")
    ...
    def test_static_scan_delete(self):
        client = Client()
    ...
    def test_static_scan_vuln_delete(self):
        ...
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(
            response, "/staticscanners/list_vuln/" + "?scan_id=%s" % scan_id
        )
        vuln_id = StaticScanResultsDb.objects.filter(vuln_id=vuln_id).values()
    ...
    def test_static_scan_vuln_list(self):
        client = Client()
