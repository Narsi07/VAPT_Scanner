...
try:
    ...
    OPENVAS_LIB_AVAILABLE = True
except ImportError:
    OPENVAS_LIB_AVAILABLE = False
    VulnscanManager = None
    VulnscanException = Exception
    print("[VAPT WARNING] openvas_lib not installed. OpenVAS remote scanning disabled. Use gvm-tools on Kali instead.")


from vaptsettings.models import OpenvasSettingDb
